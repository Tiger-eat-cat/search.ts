import { SearchTreeNode, Formatter } from './types';
export declare const buildSearchTree: (searchArray: string[]) => SearchTreeNode;
export declare const findFromTopNode: (contents: string[], tree: SearchTreeNode, position: number, searchResult: unknown[], formatter?: Formatter | undefined) => void;
